<x-app-layout>
    <x-slot name="header">
        Mascotas - Mascotas - {{ $pet->name }} - # {{ $trace->num }} - Editar Seguimiento
    </x-slot>
            ...
            <div class="flex justify-center mt-8">
                <div class="w-full md:w-1/2">
                    <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                        {!! Form::model($trace, ['route' => ['pet.trace.update', ['pet' => $pet, 'trace' => $trace]], 'method' => 'put' ]) !!}
                            @include('pet.pet.trace.components.form-elements')
                            @if ($errors->any())
