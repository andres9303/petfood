<x-app-layout>
    <x-slot name="header">
        Personas - Clientes - {{ $client->name }} - Editar Cliente
    </x-slot>
            ...
            <div class="flex justify-center">
                <div class="w-full md:w-1/2">
                    <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                        {!! Form::model($client, ['route' => ['client.update', ['client' => $client, 'type' => 'isclient']], 'method' => 'put' ]) !!}
                            @livewire('forms.person-form', ['person' => $client])                        
                            @if ($errors->any())
