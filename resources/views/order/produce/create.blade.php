<x-app-layout>
    <x-slot name="header">
        Gestión de Pedidos - Preparaciones - Planear Preparación
    </x-slot>
            ...
            <div class="flex justify-center mt-0">
                <div class="w-full">
                    <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                        {!! Form::open(['route' => 'produce.store']) !!}
                            @include('order.produce.components.form-elements')
                            @if ($errors->any())
                            ...
                            @endif
                            <div class="mt-6">
                                {!! Form::button('<i class="fas fa-mortar-pestle"></i> Planear', ['type' => 'submit', 'class' => 'bg-green-500 block mt-1 w-full hover:bg-green-600 text-white py-2 px-4']) !!}
                            </div>
                        {!! Form::close() !!}
                        </div>
                    </div>
