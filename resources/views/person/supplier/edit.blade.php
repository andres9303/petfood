<x-app-layout>
    <x-slot name="header">
        Personas - Proveedores - {{ $supplier->name }} - Editar Proveedor
    </x-slot>
            ...
            <div class="flex justify-center">
                <div class="w-full md:w-1/2">
                    <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                        {!! Form::model($supplier, ['route' => ['client.update', ['client' => $supplier, 'type' => 'issupplier']], 'method' => 'put' ]) !!}
                            @livewire('forms.person-form', ['person' => $supplier])                        
                            @if ($errors->any())
