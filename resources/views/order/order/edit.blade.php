<x-app-layout>
    <x-slot name="header">
        Gestión de Pedidos - Pedidos - # {{ $order->num }} - Editar Pedido
    </x-slot>
            ...
            <div class="flex justify-center mt-8">
                <div class="w-full md:w-1/2">
                    <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                        {!! Form::model($order, ['route' => ['order.update', ['order' => $order]], 'method' => 'put' ]) !!}
                            @include('order.order.components.form-elements')
                            @if ($errors->any())
