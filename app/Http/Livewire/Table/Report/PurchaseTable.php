...
final class PurchaseTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        return [
            Exportable::make('Compras_'.Carbon::now()->format('d-m-Y_H-i-s'))
                ->striped()
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Unidad Compra', 'unit_name', 'units.name')
                ->sortable()
                ->searchable(),

            Column::make('Cantidad Compra', 'cant')
                ->sortable()
                ->searchable()
                ->visibleInExport(true)
                ->hidden(),

            Column::make('Cantidad Compra', 'cant_formatted')
                ->sortable()
                ->searchable()
            ...
            Column::make('Unidad Inv', 'unit_base_name', 'units_base.name')
                ->sortable()
                ->searchable(),
