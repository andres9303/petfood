<x-app-layout>
    <x-slot name="header">
        Maestros - Categorías de productos - {{ $category->name }} - Editar Categoría de productos
    </x-slot>
            ...
            <div class="flex justify-center">
                <div class="w-full md:w-1/2">
                    <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                        {!! Form::model($category, ['route' => ['category.update', ['category' => $category]], 'method' => 'put' ]) !!}
                            @include('master.category.components.form-elements')
                            @if ($errors->any())
