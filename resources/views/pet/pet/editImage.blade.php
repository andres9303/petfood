<x-app-layout>
    <x-slot name="header">
        Mascotas - Mascotas - {{ $pet->name }} - Editar Mascota - Imagen
    </x-slot>
            ...
            <div class="flex justify-center mt-8">
                <div class="w-full md:w-1/2">
                    <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                        {!! Form::model($pet, ['route' => ['pet.update.image', ['pet' => $pet]], 'files' => true, 'method' => 'put' ]) !!}
                        <div class="text-gray-500">
                            <div class="mt-4">
                                {!! Form::label('image', 'Imagen de la mascota') !!}
                            ...
                            <div class="mt-4">
                                ...
                                <div class="w-48 h-48 bg-gray-100 rounded-md overflow-hidden">
                                    <img id="image-preview" class="w-full h-full object-cover" src="{{ $pet->image ? Storage::url($pet->image->url) : asset('storage/mascota/default.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                            @if ($errors->any())
