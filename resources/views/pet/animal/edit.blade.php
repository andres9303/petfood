<x-app-layout>
    <x-slot name="header">
        Mascotas - Tipos de mascotas - {{ $animal->name }} - Editar Tipo de Mascota
    </x-slot>
            ...
            <div class="flex justify-center">
                <div class="w-full md:w-1/2">
                    <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                        {!! Form::model($animal, ['route' => ['animal.update', ['animal' => $animal]], 'method' => 'put' ]) !!}
                            @include('pet.animal.components.form-elements')
                            @if ($errors->any())
