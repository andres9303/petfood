<x-app-layout>
    <x-slot name="header">
        Gestión de Pedidos - Despachos - Preparación #{{ $produce->num }} - Despacho {{ $dispatch->num }}
    </x-slot>
    <x-crud-index>
        <x-slot name="actions">
            ...
            <div class="flex justify-center">
                <div class="w-full">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                        ...
                        {!! Form::model($dispatch, ['route' => ['dispatch.update', ['produce' => $produce, 'dispatch' => $dispatch]], 'method' => 'put' ]) !!}
                        ...
                        <div class="bg-gray-50 text-gray-500 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full md:col-span-2 block">
                            @livewire('forms.dispatch-form', ['dispatch' => $dispatch])
                        </div>
                    </div>
                </div>
            </div>
